System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_showOnMap_label: 'הצג במפה',
  _action_addToMap_label: 'הוסף למפה',
  showOnMapData: 'הצג נתוני מפה',
  addedData: 'הנתונים נוספו',
  failToAddTheDataOnMap: 'הוספת הנתונים נכשלה.',
  addToMapData: 'הוסף לנתוני המפה'
})}}});