System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_showOnMap_label: 'Visa på karta',
  _action_addToMap_label: 'Lägg till på karta',
  showOnMapData: 'Visa på kartdata',
  addedData: 'data lades till',
  failToAddTheDataOnMap: 'Det gick inte att lägga till data.',
  addToMapData: 'Lägg till i kartdata'
})}}});