System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_addToMap_label: 'Dodaj karti',
  showOnMapData: 'Prikaži na podacima karte',
  addedData: 'dodani podaci',
  failToAddTheDataOnMap: 'Dodavanje podataka nije uspjelo.',
  addToMapData: 'Dodaj u podatke karte'
})}}});