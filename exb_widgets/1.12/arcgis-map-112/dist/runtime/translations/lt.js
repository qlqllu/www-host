System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_showOnMap_label: 'Parodyti žemėlapyje',
  _action_addToMap_label: 'Pridėti į žemėlapį',
  showOnMapData: 'Rodyti žemėlapio duomenyse',
  addedData: 'pridėti duomenys',
  failToAddTheDataOnMap: 'Nepavyko pridėti duomenų.',
  addToMapData: 'Pridėti duomenis į žemėlapį'
})}}});