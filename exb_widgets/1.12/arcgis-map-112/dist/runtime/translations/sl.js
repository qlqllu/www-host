System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_showOnMap_label: 'Prikaži na karti',
  _action_addToMap_label: 'Dodaj na karto',
  showOnMapData: 'Prikaži na karti podatkov',
  addedData: 'dodani podatki',
  failToAddTheDataOnMap: 'Dodajanje podatkov ni uspelo.',
  addToMapData: 'Dodaj k podatkom karte'
})}}});