System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_showOnMap_label: 'Mostrar no mapa',
  _action_addToMap_label: 'Adicionar no mapa',
  showOnMapData: 'Mostrar em dados do mapa',
  addedData: 'dados adicionados',
  failToAddTheDataOnMap: 'Falha ao adicionar os dados.',
  addToMapData: 'Adicionar aos dados do mapa'
})}}});