System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_showOnMap_label: 'Mostra-ho al mapa',
  _action_addToMap_label: 'Afegeix-ho al mapa',
  showOnMapData: 'Mostra-ho a les dades del mapa',
  addedData: 'dades afegides',
  failToAddTheDataOnMap: 'No s\'han pogut afegir les dades.',
  addToMapData: 'Afegeix a les dades del mapa'
})}}});