System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_showOnMap_label: 'Afficher sur la carte',
  _action_addToMap_label: 'Ajouter à la carte',
  showOnMapData: 'Données à afficher sur la carte',
  addedData: 'données ajoutées',
  failToAddTheDataOnMap: 'Échec de l’ajout des données.',
  addToMapData: 'Ajouter aux données de la carte'
})}}});