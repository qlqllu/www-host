System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_showOnMap_label: 'Kuva kaardil',
  _action_addToMap_label: 'Lisa kaardile',
  showOnMapData: 'Kuva kaardiandmetes',
  addedData: 'lisati andmed',
  failToAddTheDataOnMap: 'Andmete lisamine nurjus.',
  addToMapData: 'Lisa kaardiandmetesse'
})}}});