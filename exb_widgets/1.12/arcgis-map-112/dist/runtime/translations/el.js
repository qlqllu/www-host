System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_showOnMap_label: 'Εμφάνιση στον χάρτη',
  _action_addToMap_label: 'Προσθήκη στο χάρτη',
  showOnMapData: 'Εμφάνιση στα δεδομένα χάρτη',
  addedData: 'προστέθηκαν δεδομένα',
  failToAddTheDataOnMap: 'Αποτυχία προσθήκης δεδομένων.',
  addToMapData: 'Προσθήκη στα δεδομένα χάρτη'
})}}});