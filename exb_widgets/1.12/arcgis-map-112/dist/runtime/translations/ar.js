System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_showOnMap_label: 'عرض على الخريطة',
  _action_addToMap_label: 'الإضافة إلى الخريطة',
  showOnMapData: 'إظهار على بيانات الخريطة',
  addedData: 'البيانات المضافة',
  failToAddTheDataOnMap: 'فشلت إضافة البيانات.',
  addToMapData: 'إضافة إلى بيانات الخريطة'
})}}});