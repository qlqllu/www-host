System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_showOnMap_label: 'Näytä kartalla',
  _action_addToMap_label: 'Lisää karttaan',
  showOnMapData: 'Näytä kartta-aineistossa',
  addedData: 'lisätty aineisto',
  failToAddTheDataOnMap: 'Aineiston lisääminen epäonnistui.',
  addToMapData: 'Lisää kartta-aineistoon'
})}}});