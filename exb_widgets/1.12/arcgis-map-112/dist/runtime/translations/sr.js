System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_showOnMap_label: 'Prikaži na mapi',
  _action_addToMap_label: 'Dodaj na mapu',
  showOnMapData: 'Prikaži podatke mape',
  addedData: 'dodati podaci',
  failToAddTheDataOnMap: 'Neuspešno dodavanje podataka.',
  addToMapData: 'Dodaj podatke za mapu'
})}}});