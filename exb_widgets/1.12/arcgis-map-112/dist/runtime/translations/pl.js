System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_showOnMap_label: 'Pokaż na mapie',
  _action_addToMap_label: 'Dodaj do mapy',
  showOnMapData: 'Pokaż na danych mapy',
  addedData: 'dodane dane',
  failToAddTheDataOnMap: 'Nie powiodło się dodanie danych.',
  addToMapData: 'Dodaj do danych mapy'
})}}});