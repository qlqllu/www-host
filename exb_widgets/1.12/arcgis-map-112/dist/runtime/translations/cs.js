System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_showOnMap_label: 'Zobrazit na mapě',
  _action_addToMap_label: 'Přidat do mapy',
  showOnMapData: 'Zobrazit na datech v mapě',
  addedData: 'přidaná data',
  failToAddTheDataOnMap: 'Nepodařilo se přidat data.',
  addToMapData: 'Přidat do mapových dat'
})}}});