System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_showOnMap_label: 'Показати на карті',
  _action_addToMap_label: 'Додати до карти',
  showOnMapData: 'Показати у даних карти',
  addedData: 'додані дані',
  failToAddTheDataOnMap: 'Не вдалося додати дані.',
  addToMapData: 'Додати до даних карти'
})}}});