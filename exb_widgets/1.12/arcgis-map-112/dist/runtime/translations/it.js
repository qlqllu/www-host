System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_showOnMap_label: 'Mostra su mappa',
  _action_addToMap_label: 'Aggiungi alla mappa',
  showOnMapData: 'Mostra i dati della mappa',
  addedData: 'dati aggiunti',
  failToAddTheDataOnMap: 'Impossibile aggiungere i dati.',
  addToMapData: 'Aggiungi ai dati mappa'
})}}});