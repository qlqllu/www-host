System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_showOnMap_label: 'Hiển thị trên bản đồ',
  _action_addToMap_label: 'Thêm vào bản đồ',
  showOnMapData: 'Hiển thị trên dữ liệu bản đồ',
  addedData: 'đã thêm dữ liệu',
  failToAddTheDataOnMap: 'Không thể thêm dữ liệu.',
  addToMapData: 'Thêm vào dữ liệu bản đồ'
})}}});