System.register([], function (_export) {return {execute: function () {_export({
  ...
  _action_showOnMap_label: 'Harita üzerinde göster',
  _action_addToMap_label: 'Haritaya ekle',
  showOnMapData: 'Harita verileri üzerinde göster',
  addedData: 'veri eklendi',
  failToAddTheDataOnMap: 'Veri eklenemedi.',
  addToMapData: 'Haritaya ekle'
})}}});