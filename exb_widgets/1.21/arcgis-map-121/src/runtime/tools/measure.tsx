    ...
    return (
      ...
      >
        ...
        <MeasureInner
          ...
          onMeasureInstanceCreated={this.handleMeasurceInstanceCreated}
...
interface MeasureInnerProps {
  ...
  measureInstance: __esri.Measurement
  activeTabIndex: number
  onMeasureInstanceCreated: (instance: __esri.Measurement) => void
...
class MeasureInner extends React.PureComponent<MeasureInnerProps, MeasureInnerState> {
  ...
  popupEnabledInfo: PopupEnabledInfo
  ...
  componentDidUpdate (prevProps: MeasureInnerProps) {
    if (this.state.apiLoaded && this.parentContainer && this.container) {
      if (!this.props.measureInstance) {
        ...
        this.props.onMeasureInstanceCreated(tempInstance)
  ...
  componentWillUnmount (): void {
    this.restorePopupEnabledForJimuMapView()
  ...
  setCurrentJimuMapView (jimuMapView: JimuMapView): void {
    ...
    if (jimuMapView) {
      this.popupEnabledInfo = {
        jimuMapView,
        popupEnabled: jimuMapView.isClickOpenPopupEnabled(),
        clickHighlightEnabled: jimuMapView.isClickHighlightEnabled()
      }
  ...
  restorePopupEnabledForJimuMapView () {
    if (this.popupEnabledInfo) {
      const { jimuMapView, popupEnabled, clickHighlightEnabled } = this.popupEnabledInfo
