...
class BaseMapInner extends React.PureComponent<BaseMapInnerProps, BaseMapInnerState> {
  ...
  basemapGalleryElement: HTMLArcgisBasemapGalleryElement
  ...
  tryUpdateBasemapGalleryElement () {
    ...
    if (this.props.mapComponentsLoaded && this.state.apiLoaded && this.state.sourceLoaded && this.container && currMapComponent && currView) {
      ...
      if (this.basemapGalleryElement) {
        if (this.basemapGalleryElement.referenceElement !== currMapComponent) {
          // update basemapGalleryElement if map component changed
          this.basemapGalleryElement.referenceElement = currMapComponent
        ...
        this.basemapGalleryElement = document.createElement('arcgis-basemap-gallery')
        this.basemapGalleryElement.referenceElement = currMapComponent
  ...
  getFinalBasemapGallerySource (orgBasemaps: __esri.Basemap[], view: __esri.MapView | __esri.SceneView) {
    ...
    return source as unknown as LocalBasemapsSource
  }
