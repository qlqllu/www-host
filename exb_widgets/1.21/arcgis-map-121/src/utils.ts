...
export type ExBPopupDockPosition = 'auto' | CustomPopupDockPosition
...
export function getValidPopupDockPosition (config: IMConfig): ExBPopupDockPosition {
  let result: ExBPopupDockPosition = null
