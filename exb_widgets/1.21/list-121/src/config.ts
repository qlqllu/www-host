...
export const GRID_TEMPLATE_WIDTH = 620
export const DYNAMIC_ROW_MIN_HEIGHT = 10
...
export interface ItemsRenderedOptions {
  row?: {
    allRows?: AllRows
...
export interface ListItemData {
  ...
  shouldUseDynamicRowHeight?: boolean
