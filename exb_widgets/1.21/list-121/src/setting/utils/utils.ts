...
export function getListActualContentPxWidth (horizontalSpace: number, widgetRect: ElementSize, scrollBarSize = SCROLL_BAR_WIDTH): number {
  return (widgetRect?.width + horizontalSpace - scrollBarSize) || 0
}
