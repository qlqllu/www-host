...
describe('image widget test, use ds', function () {
  ...
  it('should render different component', () => {
    const { getBySelector, rerender } = render(<Widget widgetId='imageTest1' {...props} />)
    expect(getBySelector('.image-gallery-content')).toBeInTheDocument()
    ...
    expect(getBySelector('.image-symbol')).toBeInTheDocument()
  })
})
