          ...
          if (result && typeof result.type === "string" &&
            ...
            if (list.length > 0) {
              array.forEach(list, function(lyr) {
                ...
                /*
                  BUG-000170525 In ArcGIS Web AppBuilder, adding feature services containing a stand-alone table 
                  through the Add Data widget does not make the table appear in the List Layers widget. #20152
                */
                var isTbl = (tableIds.indexOf(lyr.id) !== -1);

                if (!isTbl && layerIds !== null && layerIds.length > 0) {
